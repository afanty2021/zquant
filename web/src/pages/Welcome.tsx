...
const Welcome: React.FC = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      desc: '完整的因子管理系统，支持因子定义、模型配置、因子计算和结果查询。支持多模型配置、批量计算、分表存储，提供标准的因子计算器框架。',
      href: '/factor',
    },
    {
      title: '绩效分析',
  ...
  const quickStartSteps = [
    ...
    },
    {
      step: 3,
      title: '一键初始化',
      content: '运行 python zquant/scripts/init_all.py 一键完成所有初始化操作，包括数据库表、角色权限、管理员用户、定时任务、数据视图、因子系统和策略模板。脚本会自动创建数据库（如果不存在）。',
    },
    {
      step: 4,
      title: '启动服务',
  ...
  const docs = [
    {
      title: '因子管理文档',
      desc: '了解因子定义、模型配置和因子计算',
      href: 'https://github.com/yoyoung/zquant/blob/main/docs/factor_management.md',
    },
    {
      title: '策略管理文档',
      desc: '了解如何创建、管理和使用策略模板',
      href: 'https://github.com/yoyoung/zquant/blob/main/docs/strategy_management.md',
    },
    {
      title: '定时任务指南',
      desc: '学习如何使用定时任务系统和任务编排',
      href: 'https://github.com/yoyoung/zquant/blob/main/docs/scheduler_guide.md',
    },
    {
      title: 'API 访问指南',
      desc: '了解如何正确访问和配置 API 服务',
      href: 'https://github.com/yoyoung/zquant/blob/main/API_ACCESS.md',
    },
    {
      title: '项目文档网站',
      desc: '访问完整的项目文档和 API 参考',
      href: 'https://github.com/yoyoung/zquant/blob/main/README.md',
    },
  ];
        ...
        >
          ...
          >
            ...
            >
              ...
              构建，提供数据服务、回测引擎、策略管理、因子管理等核心功能。最新版本新增完整的因子管理系统，通过Repository模式重构和批量查询优化，实现了性能提升90%+，旨在为量化分析者提供从数据采集、因子研究、策略开发、回测分析到结果管理的一站式解决方案。
            </Paragraph>
            <Paragraph
              style={{
                fontSize: '14px',
            ...
            items={[
              {
                ...
                children: (
                  <div style={{ padding: '16px 0' }}>
                    ...
                    <Paragraph>
                      <Text strong>3. 一键初始化</Text>
                      <br />
                      <Text code>python zquant/scripts/init_all.py</Text>
                      <br />
                      此脚本会自动完成所有初始化操作：
                      <br />
                      - 创建数据库（如果不存在）和所有表
                      ...
                      <br />
                      <Text type="secondary" style={{ fontSize: '12px' }}>
                        如需跳过某些步骤，可使用 --skip-* 参数，例如：--skip-view 跳过视图初始化
                      </Text>
                    </Paragraph>
                    <Paragraph>
